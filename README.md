...
Three additional containers are included that handle **Composer**, **NPM**, **Cron** and **Artisan** commands **_without_** having to have these platforms installed on your local computer. Use the following command examples from your project root, modifying them to fit your particular use case.
...
before running **cron container**, laravel must be up and running
